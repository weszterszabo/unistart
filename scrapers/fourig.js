...
exports.scrape = async function(companyName, baseUrl) {
  ...
  while (hasMore) {
    ...
    try {
      ...
      // 1. STRATÉGIA: Keresünk BÁRMILYEN blokkot, amiben benne van a "jobTitle-link"
      ...
      while ((match = itemRegex.exec(html)) !== null) {
        ...
        if (!link.startsWith("http")) {
          link = "https://karrier.4iggroup.hu" + link;
        }
      ...
      console.error(`   ❌ [4iG / ONE] Hálózat hiba:`, err.message);
      hasMore = false;
    }
  }
