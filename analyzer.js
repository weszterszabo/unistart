...
const scamDict = {
    "MLM / Piramisjáték": /\b(nem mlm|piramis|hálózatépítés|építsd fel a saját csapatod|passzív jövedelem|csatlakozási díj|regisztrációs díj)\b/i,
    "Gyanús ügynöki munka": /\b(legyél a saját magad főnöke|korlátlan kereseti lehetőség|nincs alapbér|jutalékos rendszer|kizárólag jutalék)\b/i
};
...
// 🔥 4 év felett szűr (1-3 éves tapasztalatot ezentúl ÁTENGEDÜNK!)
...
// A túl általános "több éves tapasztalat" tiltását lazítjuk, csak ha "vezetői/senior" szó is van mellette:
